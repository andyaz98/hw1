...
function search(event){
    fetch("http://localhost:8080/hw1/Script%20php/get_flights.php?departure="+FORM.departure.value+"&arrival="+FORM.arrival.value+"&directOnly="+document.getElementById("direct").checked).then(onResponse).then(showFlights);
