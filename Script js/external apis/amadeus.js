...
function request_token_1(){
    ...
    fetch("http://localhost:8080/hw1/Script%20php/external%20apis/amadeus.php").then(onResponse).then(search_flights_for_destination_1);
...
function request_token_2(){
    ...
    fetch("http://localhost:8080/hw1/Script%20php/external%20apis/amadeus.php").then(onResponse).then(search_flights_for_destination_2);
...
function request_token_3(){
    ...
    fetch("http://localhost:8080/hw1/Script%20php/external%20apis/amadeus.php").then(onResponse).then(search_flights_for_destination_3);
...
function request_token_4(){
    ...
    fetch("http://localhost:8080/hw1/Script%20php/external%20apis/amadeus.php").then(onResponse).then(search_flights_for_destination_4);
...
function request_token_5(){
    ...
    fetch("http://localhost:8080/hw1/Script%20php/external%20apis/amadeus.php").then(onResponse).then(search_flights_for_destination_5);
