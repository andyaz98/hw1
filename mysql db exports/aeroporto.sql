...
--
-- Host: 127.0.0.1
-- Creato il: Mag 24, 2022 alle 17:49
...
--
-- Struttura della tabella `accompagna`
--

CREATE TABLE `accompagna` (
  `accompagnatore` varchar(50) NOT NULL,
  `passeggero` varchar(50) NOT NULL
...
CREATE TABLE `accompagnatore` (
  ...
  `id_compagnia` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indici per le tabelle `accompagna`
--
ALTER TABLE `accompagna`
  ADD PRIMARY KEY (`accompagnatore`,`passeggero`);
...
--
ALTER TABLE `prenota`
  ADD PRIMARY KEY (`passeggero`,`volo`);
...
--
-- Limiti per la tabella `terminal`
--
ALTER TABLE `terminal`
  ADD CONSTRAINT `terminal_ibfk_1` FOREIGN KEY (`aeroporto`) REFERENCES `aeroporto` (`codice`);
COMMIT;
